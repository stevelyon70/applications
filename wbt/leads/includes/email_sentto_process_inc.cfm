...
<cfset variables.filetoSend = "WaterBidTracker_lead_detail_#bidID##userID##todate#.pdf">
...
<cfdocument format="pdf" filename="D:\gateway_attachments\#variables.filetoSend#" encryption="128-BIT" permissions="ALLOWPRINTING" pagetype="LETTER" overwrite="YES" >
    <img src="../../assets/images/WBT_Logo_WebHeader_Home_DoubleSize.png" width="300" alt="Water BidTracker" border="0"> 
    <p class="BigBold" style="margin-top: 18; margin-bottom: 12">Water BidTracker Project Detail</p>
...
<cfif tosubject EQ "">
	<cfset tosubject = "#emailname# sent you something from Water BidTracker">
</cfif>
			...
			<table width="100%" cellspacing="0" cellpadding="0">
				<tr>
					<td width="50%">
						...
						<img src="https://app.waterbidtracker.com/assets/images/WBT_Logo_WebHeader_Home_DoubleSize.png" width="300" alt="Water BidTracker" border="0"> 						
						</a>
					</td>
					<td width="50%" align="right" valign="top">
						<p style="margin-right: 6; margin-top: 12">
						<font face="Arial, Helvetica, sans-serif" size="3" color="333399">
						<b>Water BidTracker Project Report</b>
						</font></p>
					</td>
				</tr>
			</table>
    ...
    <tr>
		<td>
			...
			<p style="margin-left: 6; margin-bottom: 3;"><font face="Arial" size="2">
				#emailname# has sent you this lead from Water BidTracker.<br><br>
			...
			<table width="100%" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td width="100%">
						...
						Technology Publishing, 1501 Reedsdale Street, Suite 2008, Pittsburgh, PA 15233
						</font></p>
					</td>
				</tr>
			</table>
