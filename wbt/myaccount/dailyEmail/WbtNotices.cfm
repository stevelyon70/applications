...
Trouble viewing this mail?</span> <a href="http://www.paintsquare.com/newsletter/tracking/bid/?nl_moduleid=1&nl_versionid=#nl_versionid#&redirectid=673&#addt_variables#" style="font-family:Verdana, Arial, Helvetica; font-size:10px; color:##fff; text-decoration:underline">Read it online</a> <span style="font-family:Verdana, Arial, Helvetica; font-size:10px; color:##fff; text-decoration:bold;">|</span> <a href="http://www.paintsquare.com/newsletter/tracking/bid/?nl_moduleid=1&nl_versionid=#nl_versionid#&redirectid=589&#addt_variables#" style="font-family:Verdana, Arial, Helvetica; font-size:10px; color:##fff; text-decoration:underline">Add to address book</a> <br /><br />
