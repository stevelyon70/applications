...
<CFMAIL SUBJECT="Paint BidTracker Bid Notices for #dateformat(todaydate, "mmmm d, yyyy")#" FROM="paintbidtracker@paintsquare.com" to="#emailaddress#"  type="html" bcc="slyon@technologypub.com">
