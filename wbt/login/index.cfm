<cfinclude template="../template_inc/design/wrapper_top.cfm">
				...
				<div class="box-login2 col-sm-6">
					...
					<cfoutput>
					<form class="form-login" method="post" action="<cfif isdefined("error")>#request.rootpath#?defaultdashboard</cfif>" enctype="multipart/form-data"><br>
						<input type="hidden" name="siteid" value="200">
						...
						<fieldset>
							...
							<div class="form-group form-actions">
								<span class="input-icon">
									...
									<a class="forgot" href="/register/?action=forgotpassword">
							...
							<div class="form-actions">
								...
								<p>
									<br>By proceeding, I agree to the Water BidTracker <a href="/dmz/?action=terms">Terms of Usage</a> and <a href="/dmz/?action=privacy">Privacy Policy</a>. 
								</p>
							</div>
							<div class="new-account">
								Don't have an account yet?
								<a href="http://www.waterbidtracker.com" class="register">
									Learn more</a> about Water BidTracker.
									<!---Learn more</a> or try Water BidTracker for <a href="http://www.waterbidtracker.com/free-trial/">free</a>.--->
