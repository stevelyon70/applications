    ...
    <div class="panel-heading" role="tab" id="headingOne">
      <div class="panel-title">
		...
		<div class="panel-title pull-right">	
			...
			<cfif isdefined("action") and action NEQ "planningresults">
			<cftooltip 
				autoDismissDelay="5000" 
				hideDelay="250" 
				preventOverlap="true" 
           ...
           <table border="0" cellpadding="0" cellspacing="0" width="100%">
							...
							<cfif isdefined("project_stage") and project_stage NEQ "">
								<cfloop query="gettype">
									<cfoutput>
									<cfif interface_stage EQ "Current Subcontracts for Painting & Related Services">
									Current Subcontracting Notices
									<cfelse>
									#interface_stage# 
									</cfif>
									<!---span class="deleteBox">[<span class="xRed">x</span>]</span---><cfif currentrow lt recordcount>,</cfif>
									</cfoutput>
								</cfloop>
							<cfelse>
								All
