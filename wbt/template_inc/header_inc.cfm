<div class="navbar navbar-inverse navbar-fixed-top">
	<div class="">
		<div class="col-sm-8 banner-logo-home">
			...
			<img src="<cfoutput>#request.rootpath#</cfoutput>assets/images/WBT_Logo_WebHeader_Home_DoubleSize.png" alt="Water BidTracker" border="0" class="img-responsive"> </a>
		</div>
				...
				<li class="dropdown notifications">
					<a data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle" data-close-others="true" href="#">
						...
						<i class="fa fa-exclamation-triangle headcss" aria-hidden="true"></i>
							...
							<span class="badge"> <span class="noteCount">0</span></span>
